...
# The SDK ships as one ~2 MB minified line with no source map, so an unhandled
# rejection dumps the whole bundle to stderr (BUGS.md B7). Filter it, or the
# screenshot is 2 MB of obfuscated JavaScript instead of the error.
